...
// address. Empty string is allowed since email is optional on clients and leads; pass
// the raw form value in and check emptiness before calling if a field is required.
...
// value the client sends. Every status/priority/type field across the app should go
// through this rather than being inserted raw.
