    ...
    <div className="w-full space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5 font-medium">
            Configure SMTP email delivery, timer parameters, goal neglect
            thresholds, and app tracking rules
          </p>
        </div>
        ...
        <div className="toota-card space-y-6 max-w-2xl">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Supports free mail providers (Gmail, Outlook.com, Yahoo) via
              app-passwords for goal nudges and client portal invites.
            </p>
          </div>
      ...
      {activeTab === "timer" && (
        <div className="toota-card space-y-6 max-w-2xl">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Customize focus durations, break lengths, auto-continue behavior,
              and overrun sound alerts.
            </p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4 pt-2 border-t border-secondary/50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    Automatically start break/work session without manual click
                  </p>
                </div>
                <button
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-bold text-foreground">
                    10-Minute Overrun Alert Sound
                  </p>
                  <p className="text-[11px] text-muted-foreground">
                    Play native OS alert sound if session runs 10 minutes past
                    target duration
                  </p>
                </div>
                <button
      ...
      {activeTab === "goals" && (
        <div className="toota-card space-y-6 max-w-2xl">
          <div>
            <h2 className="text-lg font-bold text-foreground">
              Consistency & Nudge Engine Settings
            </h2>
            <p className="text-xs text-muted-foreground mt-0.5">
              Set default goal neglect thresholds and automated notification
              rules.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-foreground">
                Default Neglect Threshold (Days)
              </label>
              <input
                type="number"
              ...
              />
              <p className="text-[11px] text-muted-foreground">
                Trigger neglect alerts if a goal is unlogged for this number of
                days
              </p>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-secondary/50">
              <div>
                <p className="text-xs font-bold text-foreground">
                  Email Notifications for Neglected Goals
                </p>
                <p className="text-[11px] text-muted-foreground">
                  Send email reminder via SMTP when threshold is crossed
                </p>
              </div>
              <button
      ...
      {activeTab === "apps" && (
        <div className="toota-card space-y-6 max-w-2xl">
          <div>
            <h2 className="text-lg font-bold text-foreground">
              Desktop App Productivity Classifications
            </h2>
            <p className="text-xs text-muted-foreground mt-0.5">
              Classify active window titles captured by the Electron tracking
              wrapper into Productive, Focused, or Unproductive categories.
            </p>
          </div>
